...
protocol NetworkService {
    func getModelAlbum<T: Decodable>(url: URL?, completion: @escaping (Result<T, NetworkError>) -> Void)
...
extension NetworkManager: NetworkService {
    ...
    func getModelAlbum<T>(url: URL?, completion: @escaping (Result<T, NetworkError>) -> Void) where T : Decodable {
